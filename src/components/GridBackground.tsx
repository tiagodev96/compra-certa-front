...
export const GridBackground = ({ children }: GridBackgroundProps) => {
  return (
    <div className="h-full min-h-screen w-full dark:bg-neutral-950 bg-neutral-50 dark:bg-grid-primary/[0.2] bg-grid-neutral-950/[0.2] relative flex justify-center">
